...
public class SendAcknowledgementMail extends ReceiveMailAttachment {
	...
	protected void sendAcknowldgement(final String password,String invoiceNumber) {
		...
		Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
			protected PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication(fromAdrs.toString(), password);
			}
		});
		// compose message
		try {
			...
			message.setText("Your number is "+invoiceNumber);
			// send message
